...
# ============== Settings ================
root = Tk()
root.title("EApayloads By: Danyal Fayazi & Amir Sadeghi")
root.geometry('420x350')  # set up the size
color = 'black'
root.configure(bg=color)
root.resizable(width=False, height=False)

name_label = Label(root,  font=('arial', 15, 'bold'), text="Danyal Fayazi & Amir Sadeghi", bg=color, fg="blue")
...
# ============== Payload Select ================
pay_label = Label(root,  font=('arial', 12, 'bold'), text="Select Your Payload", bg=color, fg="red")
...
# ============== IP/PORT Select ================
ip_label = Label(root,  font=('arial', 12, 'bold'), text="Enter Your IP Address", bg=color, fg="red")
ip_label.place(x=120, y=70)

ip_entry = Entry(root, bd=7)
ip_entry.place(x=115,y=100)

port_label = Label(root,  font=('arial', 12, 'bold'), text="Enter Your Port Number", bg=color, fg="red")
port_label.place(x=120, y=150)

port_entry = Entry(root, bd=7, width=7)
port_entry.place(x=166,y=177)
# ============== File Name Select ===============
filename_label = Label(root,  font=('arial', 12, 'bold'), text="File Name:", bg=color, fg="red")
